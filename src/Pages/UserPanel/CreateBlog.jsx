...
const CreateBlog = () => {
  ...
  return (
    <div className="max-w-[90%] mx-auto p-8 bg-gradient-to-b from-gray-50 to-white min-h-screen">
      <h2 className="text-3xl font-extrabold text-gray-900 mb-8 text-center">Create Blog</h2>
      {error && (
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-xl shadow-lg">
          ...
          {editorReady ? (
            <div className="border border-gray-300 rounded-lg overflow-hidden shadow-sm">
              <CKEditor
                ...
                onReady={(editor) => {
                  if (isSubmitting) {
                    editor.enableReadOnlyMode('create-blog');
                  } else {
                    editor.disableReadOnlyMode('create-blog');
                  }
        ...
        <div>
          ...
          <input
            type="file"
            id="cover_image"
            onChange={(e) => setBlogData({ ...blogData, cover_image: e.target.files[0] })}
