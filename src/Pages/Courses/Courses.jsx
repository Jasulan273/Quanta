      ...
      <div className="w-[25%] p-6 rounded-lg">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center space-x-2">
            <input type="date" className="border p-2 rounded w-[115px]" />
            <span>-</span>
            <input type="date" className="border p-2 rounded w-[115px]" />
          </div>
          <button className="mt-4 w-full bg-primary text-white p-2 rounded-lg hover:translate-y-[-2px] transition">
            Apply
          </button>
        </div>
      </div>
