    ...
    <div className="w-container mx-auto mt-40 mb-20">
      ...
      >
        {posts.map((post) => (
          <div
            key={post.id}
            className={`max-w-sm h-[474px] bg-white rounded-[24px] shadow-md overflow-hidden hover:scale-105 hover:shadow-xl transition duration-300 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
          >
            ...
            <div className="p-5 flex flex-col h-[224px]">
              ...
              <div className="text-left mt-2">
                <p className="flex flex-row items-center text-[16px] text-gray-600">
                  <img src={Calendar} className='mr-1 w-[18px]' alt="" />
                  {post.date} | 
                  <img src={Date} className='mx-1 w-[18px]' alt="" />
                  {post.reads} Views
                </p>
              </div>
